...
if heightfieldSource==useProgrammatic:
  ...
  for j in range (numHeightfieldColumns - 1):
    for i in range (numHeightfieldRows - 1):
      ...
      if j > int(numHeightfieldColumns/2) and i > int(numHeightfieldRows/2):
        height = 2.0
      else:
        height = .0
  ...
  terrainShape = p.createCollisionShape(shapeType = p.GEOM_HEIGHTFIELD, meshScale=[1,1,1], heightfieldTextureScaling=(numHeightfieldRows-1)/2, heightfieldData=heightfieldData, numHeightfieldRows=numHeightfieldRows, numHeightfieldColumns=numHeightfieldColumns)
