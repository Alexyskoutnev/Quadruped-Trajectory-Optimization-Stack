...
numHeightfieldColumns = 20 
heightData = np.zeros((numHeightfieldRows, numHeightfieldColumns))
if heightfieldSource==useProgrammatic:
    height = 0.0
    for i in range (int(numHeightfieldRows/2), numHeightfieldRows):
        print(i)
        heightData[i, :] = height
        ...
        # if i % 2 == 0:
        height += 0.25
    heightData = heightData.flatten()

    # breakpoint()
      
    terrainShape = p.createCollisionShape(shapeType = p.GEOM_HEIGHTFIELD, meshScale=[1,1,1], heightfieldTextureScaling=1, heightfieldData=heightData, numHeightfieldRows=numHeightfieldRows, numHeightfieldColumns=numHeightfieldColumns)
